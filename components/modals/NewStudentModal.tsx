...
export function NewStudentModal({ visible, onClose, onStudentAdded }: NewStudentModalProps) {
...
const styles = StyleSheet.create({
  ...
  levelButtons: { flexDirection: 'row', marginBottom: 16 },
  levelButton: { flex: 1, marginHorizontal: 4 },
  footer: {
    flexDirection: 'row',
    padding: 16,
    borderTopWidth: 1,
